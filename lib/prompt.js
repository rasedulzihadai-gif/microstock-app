...
C. Maximum 6 generic/abstract descriptor keywords per platform output (e.g. modern, abstract, creative, art, aesthetic, style, element, design, structure, contemporary, visual, effect, composition, surface, tech, digital, technology, cyber, system, display). Treat near-synonyms as ONE slot, not several — "tech", "digital", "technology", and "cyber" together count as at most 1 of the 6, pick the single strongest one. If over 6 after deduping synonyms, cut the weakest and replace with color or use-case keywords instead.
D. Never include a mood/style descriptor that isn't visually confirmed by concrete visual evidence (an actual texture, era-specific pattern, or color treatment you can point to in the image). Never include two descriptors that pull in opposite directions (e.g. "vibrant" AND "pastel", "dark" AND "bright", "retro"/"vintage" AND "futuristic"/"cyber"/"modern"/"tech"). When a futuristic/tech theme is present, "retro" is almost always wrong — omit it unless the image shows genuinely aged, worn, or era-specific texture.
...
- No more than 6 generic/abstract descriptors, synonyms deduped to 1 slot (rule C)
